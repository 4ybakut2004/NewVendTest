...
working_directory "/var/www/apps/NewVend/current" # available in 0.94.0+
...
# Устанавливаем путь к PID файлу главного процесса unicord
pid "/var/www/apps/NewVend/run/unicorn.pid"

# Направляем потоки вывода
stderr_path "/var/www/apps/NewVend/log/unicorn.stderr.log"
stdout_path "/var/www/apps/NewVend/log/unicorn.stdout.log"
...
#Это лишь гарантирует определене клиентов на том же хосте, что и юникорн.
